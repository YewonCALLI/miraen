...
import { CameraControllerProps, CameraPose } from './types';
...
export default function CameraController({ 
  ...
  const cameraPoses = useMemo<Record<string, CameraPose>>(() => ({
    ...
    '0,0,5': { 
      position: new THREE.Vector3(0, 0.56, 5),
      lookDirection: new THREE.Vector3(0, 0, -0.3),
      initialPitch: -Math.PI/15,
      initialYaw: 0
    },
  ...
  // 카메라 방향 업데이트 함수
  const updateCameraDirection = useCallback((saveLastLookAt: boolean = true) => {
